...
However, these indices do not measure independence, for two reasons. First, these measures leave out the strength of the institutions enforcing the laws of the central bank.

 The Fed is not ``more independent" in any subindex (although it ties in ``Financial independence" subindex from \textcite{romelli_trends_2024}). The `objectives" component gives the biggest gap between the two nations for \textcite{romelli_trends_2024} and the second most for \textcite{garriga_revisiting_2025}. 
...
\subsubsection{De Facto Independence}
