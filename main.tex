...
Comparing the United States and Turkey helps illustrate why the inclusion of an objectives component can bias an index. Recall that the United States legally has a ``tripartite" monetary policy mandate which it coloqially refers to as its ``dual mandate." While, in practice, this may not significantly alter monetary policy, the ability for the Federal Reserve to simply ignore a piece of the law compromises the principle of goal independence. All of the aforementioned de jure measures of CBI code the Federal Reserve's monetary policies as the ``dual mandate." The underlying problem for these indices is that if Congress decided to revise the Federal Reserve's mandate, this decision would alter the Federal Reserve's CBI score. For instance, if Congress eliminated the unemployment component of the dual mandate, the United States CBI score would universally increase. This intrinsic action does not influence, definitionally, goal \textit{or} instrument independence, because Congress would still be responsible for setting monetary policy objectives (goal dependence) and would not have changed its ability to influence individual policy decisions (instrument independence). However, the measurement of CBI in every de jure index would significantly changed.

To understand how the inclusion of objectives in de jure indices biases analysis, we can use a comparison of the United States and Turkey as a case study. 

\begin{table}[htbp]
\centering
\caption{Central Bank Independence Scores: United States vs.\ Turkey (2023), \textcite{romelli_trends_2024} }
...
\begin{table}[htbp]
\centering
\caption{Central Bank Independence Scores: United States vs.\ Turkey (2023), \textcite{garriga_revisiting_2025}}
...
\begin{table}[htbp]
\centering
\caption{Central Bank Independence Scores: United States vs.\ Turkey (2023), \textcite{dincer_central_2024}}
