...
%%%Apolitical MP- MP doesn't matter any more
...
The theory behind the conservative central banker has influenced the way policymakers communicate about monetary policy. Among all the speeches that reference \textcite{rogoff_optimal_1985}, none strongly criticize the conservative central banker model. There are general acknowledgements of the limitations of the model, but the tone communicated generally endorses the core findings. Consider \textcite{bernanke_frb_2004}. First, the premise of this speech is to endorse the decisions made by Paul Volcker in the late 1970s. W
...
Schnabel sums it up perfectly, when describing the implications of price stability and the dual mandate
