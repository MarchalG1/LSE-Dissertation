...
Literature has questioned the narrative about the proliferation of central bank independence being tied to economic performance and the time inconsistency problem. One could imagine a situation where politicians could pass irresponsible economic policy, like large tax cuts or direct payments to citizens, immediately before elections. . Furthermore, built into the time inconsistency problem, as previously described, is an assumption that politicians should not be entrusted, primarily because of their incentives to stimulate the economy before elections and because of their lack of expertise on monetary policy. This assumption assumes that the technocrats within a central bank are both unbiased and have a unique skillset that is important to guide monetary policy Futhermore, episodes like the 2008 recession and the post-COVID spike in inflation highlight how the Fed's technocratic justification may be imperfect. Like all agencies, it makes mistakes, but in a world of independence, it politically holds itself to a higher bar.

Furthermore, the technocrats themselves in most economic models are perceived to be unbiased individuals who implement monetary policy for the good of the entire nation. However, there is no such thing as either an unbiased bureaucrat or a universally optimal monetary policy. Economists, like all academics and policymakers, are prone to bias, from career incentives and professional socialization to personal experiences that influence how they see the world. This matters because monetary policy is not a ``one-size-fits-all" policy; there are important normative questions that have large distributional consequences. For instance, which banks can access lending facilities from the Fed, the implementation of asset purchases, and the optimal goals of monetary policy are not questions that have a universal correct answer.  
