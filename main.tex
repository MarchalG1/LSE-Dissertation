...
Given the double delegation of policy, it seems natural that many central bankers have their roots in finance. Central banks and financial institutions work closely together, so there is an understanding of the financial system that can be f
...
Furthermore, the technocrats themselves in most economic models are perceived to be unbiased individuals who implement monetary policy for the good of the entire nation.

Technocracy as institution building.

Decisions with distributional or normative consequences are traditionally handled by politicians in a functioning democratic society. Voters theoretically can exercise their frustrations or support in the ballot box, ensuring that the policies implemented have their perspectives in mind. The question of whether the United States is a functioning democracy is beyond the scope of this paper. However, the scope of this paper handles whether it is good for voters to be unable to influence the goals of monetary policy.

It is worth noting that none of the aforementioned political science pieces show up in any speeches.

%%%Polisci literature that calls into question the conservative central banker

%The arrangement of how Fed officials communicate their decisions- and how politicians just kind of are good with it. Maybe bernanke as well.

%%%Apolitical MP- MP doesn't matter any more to politics

%Lindblom should probably go here, at the end.

%The simplistic models in the historical literature no longer apply- because of all the unique policies that exist in MP today.

%The loneliness of a central bank, and how MP now is the core macroeconomic stabilization policy. That's why a lot of this matters- because fiscal policy just doesn't achieve much.

%Weaponized incompetence and Congress, with the Bernanke example.
...
{
%Conceptualizations of regulatory capture are often rooted in the seminal work by \cite{stigler_theory_1971}. Dal bo, kwak. 
...
%Consider how financial institutions have performed since in the modern era of central bank independence. The Federal Reserve has a unique relationship with finance because financial firms, not the Fed, are responsible for lending to the real economy. In other words, monetary policy is executed through financial firms. In the last 40 years, the growth in finance has dr
}
