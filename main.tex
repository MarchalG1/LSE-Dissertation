...
First, Federal Reserve officials acknowledge and support the distinction between instrument and goal independence. This  For instance, \textcite{powell_speech_2023} directly cites \textcite{debelle_how_1994} to explicitly to invoke that "the Federal Reserve's monetary policy independence corresponds to operational, or instrument, independence, rather than goal independence." 
However, the literature that conflates goal and instrument independence is repeatedly utilized in Fed speeches. 

The theory behind the conservative central banker has influenced the way policymakers communicate about monetary policy. Among all the speeches that reference \textcite{rogoff_optimal_1985}, none strongly criticize the conservative central banker model. There are general acknowledgements of the limitations of the model, but the tone communicated generally endorses the core findings. Consider \textcite{bernanke_what_2004}. First, its worth noting that the premise of this speech is to endorse the decisions made by Paul Volcker in the late 1970s. Bernanke invokes \textcite{rogoff_optimal_1985} directly, stating that ``giving the central banker an objective function that differs from the true objectives of society may be useful" with regards to fighting inflation. He then suggests that ``these ideas, supported by a great deal of empirical work, have proven highly influential." 


In the same tradition, \textcite{powell_panel_2023} does the same, highlighting the importance of the conservative central banker model presented by \textcite{rogoff_optimal_1985} as well as the empirical evidence developed by \textcite{alesina_central_1993} and \textcite{crowe_central_2008}\footnote{need to address the underlying stuff in this.}. 
%Roger Ferguson, April 27, 2005: the mandate really contained three goals, but the last one has been widely interpreted as those long-term interest rates consistent with the first two goals, giving the Federal Reserve a "dual mandate" of maximum employment and stable prices.%Charles L Evans, October 17, 2011: "And many of us are conditioned by the work of Ken Rogoff8 and others, who note that in normal times, we may want conservative central bankers as institutional offsets to what would otherwise be inflationary biases in the monetary policy process." Describing the conditioning of central bankers and an anti-inflation bias. 


Governor Laurence Meyer is one of the first policymakers to explicitly reference de jure independence index. First, in \textcite{meyer_politics_2000}, he describes how, under the methodology of \textcite{grilli_political_1991} and \textcite{cukierman_measuring_1992}, when ``price stability is the exclusive objective of monetary policy," a central bank scores better, so the Fed is penalized for having a dual mandate. He explicitly prefers \textcite{bade_central_1988}'s measure because of this flaw. He also defends the dual mandate, and acknowledges a public debate that occurred in Congress about revising the dual mandate- prioritizing price stability or employment. However, it is worth noting that \textcite{meyer_monetary_1996} interprets the Fed's dual mandate as primarily a price stability mandate, at least in the long-run under the doctrine of monetary neutrality. Thus, there is a tension between the two speeches; economic theory would defend the indices, by construction, because monetary policy only matters for inflation in the long-run. Yet, as a policymaker, he defends, to some degree, including the employment objective.\footnote{Note there is no conversation of long-term interest rates.} 

Future speeches by Federal Reserve officials appear to have resolved this tension by preferring independence measures that include the price stability objective. 

I am not trying to imply that officials at the Federal Reserve take one stance or the other. I am saying they explicitly endorse papers that conflate goal and instrument independence, and this has significant consequences on the way they think about CBI. 
