...
\begin{center}
    ...
    \vspace{2cm}
    {\Large\textbf{Assumptions Matter: Central Bank Independence, Epistemology, and Finance}}\\
    \vspace{2cm}
...
\begin{itemize}
    ...
    \item \textbf{Infrastructural power (Wanslaben)} --- The Fed is a bureaucracy, and its innovations in monetary policy (governing techniques) have allowed it to grow and prosper. Financial interests are not relevant in this development.
...
\begin{itemize}
    ...
    \item \textbf{``Ingrained'' framing} --- Financial interests weren't subsequently captured by the Fed. They were built into the epistimelogical framing of CBI.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Posen (1995)} --- The conservative central banker's preferences are those of the financial sector; it is the financial sector's support that determines levels of CBI.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Does double work} --- Justifies CBI on meritocratic grounds AND pre-emptively delegitimises democratic oversight.
...
\begin{itemize}
    ...
    \item \textbf{Wanslaben (2020} --- The Fed as bureaucracy and institution building

    \begin{itemize}
        \item     \item \textbf{Mabbett and Schelkle} --- Broader discussion of the Fed's ``loneliness.''
    \end{itemize}
...
\textit{There is an entire literature ingraining special interests of finance at the very beginning. The motivating question how two literatures --- economics and political science --- came to such radically different conclusions, and how the conclusions of one came to be encoded in institutional design.
}
...
\begin{itemize}
    ...
    \item \textbf{Rogoff's conservative central banker} --- A central banker is not supposed to reflect the interests of the public but to be more inflation-averse than the public

    \item \textbf{Posen and the interests of finance} --- Finance is more inflation averse than the public

    \begin{itemize}

    \item \textbf{Implication} --- The conservative central banker directly reflects the interests of finance
...
\textit{Describe general strategy of literature; Measuring de jure independence, building indices, etc...}
...
\begin{itemize}
    ...
    \item \textbf{Mandate revision toward employment lowers most index scores} --- If Congress exercised its constitutional authority to revise the mandate, the Fed's independence score would fall. That proves the circularity.
...
\textit{The economics literature prior doesn't stay in journals. It travels into institutions through specific channels --- and those channels are what this section traces.}
...
\textit{The defences of legislative inaction use the same assumptions exposed in Section 4.1. That's the circularity: the literature that encodes financial preferences is the same literature mobilised to argue revision is unnecessary.} \textbf{THIS IS MY WEAKEST SECTION: I need more evidence analyzing the role of finance in this blockage}
...
\begin{itemize}
    ...
    \item \textbf{Contribution 2} --- CBI measurement is circular. Measurement based on legal goals, not instrument independence.
