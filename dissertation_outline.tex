...
\begin{itemize}
    ...
    \item \textbf{Infrastructural power (Wansleben)} --- The Fed is a bureaucracy, and its innovations in monetary policy (governing techniques) have allowed it to grow and prosper. Financial interests are not relevant in this development.
...
\begin{itemize}
    ...
    \item \textbf{``Ingrained'' framing} --- Financial interests weren't subsequently captured by the Fed. They were built into the epistemological framing of CBI.
\end{itemize}
